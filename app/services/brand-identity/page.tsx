...
export default function BrandIdentityPage() {
    return (
        <PageTemplate>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mt-12">
                    ...
                    >
                        ...
                        <div className="absolute bottom-6 left-6 text-white p-4">
                            <div className="text-sm font-bold bg-[#3C8ECB] px-3 py-1 rounded-full inline-block mb-2">TechFleek Branding</div>
                            <h3 className="text-2xl font-bold">Unforgettable Identity</h3>
                        </div>
                    </motion.div>
            ...
            <TechStack
                items={tools}
                title={<>Creative <span className={homeStyles.gradientText}>Toolkit</span></>}
                description="Industry standard tools for professional results."
            />
