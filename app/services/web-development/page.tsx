...
import { Globe, Code2, ShoppingCart, Zap, Server, Lock, Gauge, Search, Users, Layers, Database, Rocket, Award, Target, Headphones } from 'lucide-react';
...
const services = [
    { icon: Code2, title: 'React & Next.js', description: 'Blazing-fast web apps with SSR, SSG, and optimal performance.', features: ['SSR & SSG', 'API Routes', 'Image Optimization'] },
    { icon: ShoppingCart, title: 'E-commerce', description: 'Secure online stores with payment gateways and inventory management.', features: ['Payment Integration', 'Cart System', 'Inventory Mgmt'] },
    { icon: Zap, title: 'Progressive Web Apps', description: 'App-like experiences with offline support and push notifications.', features: ['Offline Mode', 'Push Notifications', 'Installable'] },
    { icon: Server, title: 'API Development', description: 'Robust RESTful and GraphQL APIs for your applications.', features: ['REST & GraphQL', 'Authentication', 'Rate Limiting'] },
];

const benefits = [
    { icon: Gauge, title: 'Lightning Fast', desc: 'Core Web Vitals optimized for better rankings.' },
    { icon: Search, title: 'SEO Optimized', desc: 'Built with SEO best practices for higher rankings.' },
    { icon: Lock, title: 'Enterprise Security', desc: 'SSL, CSRF protection, security headers included.' },
    { icon: Users, title: 'Accessible Design', desc: 'WCAG compliant designs for everyone.' },
];

const processSteps = [
    { step: '01', title: 'Discovery', description: 'Requirements, audience analysis, project roadmap.' },
    { step: '02', title: 'Design', description: 'Beautiful wireframes aligned with your brand.' },
    { step: '03', title: 'Development', description: 'Clean, maintainable code with regular demos.' },
    { step: '04', title: 'Launch', description: 'Testing, deployment, and ongoing maintenance.' },
];
...
const techStack = [
    ...
    { name: 'HTML5', icon: '/Home-Page/icons/html.png' },
    { name: 'CSS3', icon: '/Home-Page/icons/css.png' },
    { name: 'Next.js', icon: '/Home-Page/icons/bootstrap.png' },
    { name: 'TypeScript', icon: '/Home-Page/icons/flutter.png' },
    { name: 'Node.js', icon: '/Home-Page/icons/firebase.png' },
    { name: 'Tailwind', icon: '/Home-Page/icons/react.png' },
];

const whyChooseUs = [
    { icon: Award, title: 'Expert Team', desc: 'Senior developers with proven track records.' },
    { icon: Rocket, title: 'Fast Delivery', desc: 'Agile methodology for quick time-to-market.' },
    { icon: Target, title: 'Results-Focused', desc: 'Websites that convert visitors into customers.' },
    { icon: Headphones, title: 'Ongoing Support', desc: 'Maintenance and updates when you need them.' },
];

const industries = ['SaaS', 'Healthcare', 'Finance', 'E-commerce', 'Education', 'Real Estate', 'Startups', 'Enterprise'];
        ...
        <>
            <main className={`${inter.className} bg-white`}>
                <ServiceDetailHero
                    ...
                    subtitle="We build modern, responsive websites and web applications that deliver exceptional user experiences across all devices."
                    icon={Globe}
                />
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                            ...
                            >
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <span className={`${redHat.className} text-[#3C8ECB] font-bold tracking-[0.2em] text-xs uppercase`}>WEB SOLUTIONS</span>
                                </div>
                                ...
                                <h2 className={`${redHat.className} text-2xl sm:text-3xl lg:text-4xl font-extrabold text-gray-900 leading-tight mb-4`}>
                                    ...
                                    <span className="bg-gradient-to-r from-[#3C8ECB] to-[#0055DF] bg-clip-text text-transparent">
                                        Web Experiences of Tomorrow
                                    </span>
                                </h2>

                                <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-6 max-w-lg">
                                    Your website is often the first impression customers have of your business. We create stunning, high-performance websites that drive real business results.
                                </p>
