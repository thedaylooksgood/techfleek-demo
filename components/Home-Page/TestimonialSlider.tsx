...
const TestimonialSlider: React.FC = () => {
        ...
        return (
            <div className="w-full bg-white py-8 px-4 flex flex-col items-center">
                ...
                <div className="flex items-center justify-center gap-4 mb-4">
                    ...
                    >
                        <ChevronLeft className="w-6 h-6 text-black hover:text-[#3C8ECB] transition-colors" />
                    </button>
                    <button
                        onClick={handleNext}
                        className="p-2 hover:scale-110 transition-transform"
                    ...
                    >
                        <ChevronRight className="w-6 h-6 text-black hover:text-[#3C8ECB] transition-colors" />
                    </button>
                </div>
    ...
    return (
        <div className="w-full bg-white py-8 md:py-10 lg:py-12 xl:py-16 flex flex-col items-center relative overflow-hidden">
            {/* Header with Arrows */}
            <div className="text-center mb-6 md:mb-8 lg:mb-10 z-10 relative space-y-1 md:space-y-2">
                ...
                <div className="flex items-center justify-center gap-4 md:gap-6 lg:gap-8">
                    ...
                    <button
                        ...
                        aria-label="Previous testimonial"
                    >
                        <ChevronLeft className="w-6 h-6 md:w-8 md:h-8 lg:w-10 lg:h-10 text-black group-hover:text-[#3C8ECB] transition-colors" />
                    </button>

                    <h2 className={`${lato.className} font-bold text-[20px] md:text-[28px] lg:text-[36px] xl:text-[42px] text-black px-2`}>
                        What Our Clients Say About Us
                    </h2>
                    ...
                    <button
                        ...
                        aria-label="Next testimonial"
                    >
                        <ChevronRight className="w-6 h-6 md:w-8 md:h-8 lg:w-10 lg:h-10 text-black group-hover:text-[#3C8ECB] transition-colors" />
                    </button>
                </div>
