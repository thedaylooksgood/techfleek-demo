...
const studyData = [
    {
        ...
        description: "AI deal-making platform for multi-million dollar transactions.",
    ...
    },
    {
        ...
        title: "Ucom Ent.",
        category: "Streaming",
        subtitle: "Movie Cloud",
        description: "Next-gen content engine serving millions of users.",
    ...
    },
    {
        ...
        description: "HIPAA-compliant virtual care ecosystem.",
    ...
    },
    {
        ...
        subtitle: "E-Commerce",
        description: "Digital-first powerhouse with 300% revenue growth.",
