...
import { X, Upload, ChevronDown, Linkedin, Facebook, User, Mail, Phone, Briefcase, FileText, Loader2, CheckCircle } from 'lucide-react';
                        ...
                        >
                            ...
                            <div className="mt-12 flex flex-col items-center gap-4">
                                ...
                                <div className="flex gap-4">
                                    {[
                                        { Icon: Linkedin, color: "#0077b5", href: "https://www.linkedin.com/company/techfleek/" },
                                        { Icon: Facebook, color: "#1877F2", href: "https://www.facebook.com/p/Techfleek-61566903430555/" },
                                        { Icon: BehanceIcon, color: "#1769FF", href: "#" }
