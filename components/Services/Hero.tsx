...
const HeroSection: React.FC<HeroSectionProps> = ({
    ...
    title = "UI/UX DESIGN",
    description = "From user research and UX audits to interaction design, design systems, and developer handoff, our UI/UX team is true experts in their field.",
    backgroundImageUrl = "/Enquiry/background.png",
    features = [{ text: "Home" }, { icon: <ChevronRight className="w-3 h-3" />, text: "" }, { text: "Services" }],
}) => {
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 flex flex-col items-center max-w-[900px]">
                {/* Breadcrumb */}
                <div className={`flex items-center justify-center mb-2 gap-0.5 ${inter.className}`}>
